...
ohss<- read_csv("/home/c/results2/output/outvfdtvfdtlowconfidence10-2real")
...
#write.table(dfkey, "/home/c/papers/unspecified_features/syntheticStreamsKey.tex", quote=FALSE, col.names = FALSE, sep = ' & ', eol = " \\\\\n",)

dfs = list(ohssE, ohssV, NA)

# Just HAT and HAT -A
#comparisonTable(c(19,5),ohssE,"/home/c/papers/unspecified_features/table1.tex")
compareTwo(dfs,"/home/c/papers/ensemble/table98.tex", c(2,1))
